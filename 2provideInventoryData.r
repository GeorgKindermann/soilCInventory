...
504100      1       2             3 n
504100      2      10            NA st0.9ba0.5
504100      3       1            NA st1ba1
504108      1       1            NA n
504108      2       1            NA st1ba1")
...
# n .. nothing, st .. stem, ba .. bark, br .. branch, le .. leaf, st .. stump,
# cr .. coarseRoot, fr .. fineRoot, se .. seed

Dt <- read.table(header = TRUE, text="
plotId treeId peri nrep    d    h  hka
504100      1    1 1200 13.1 12.7  4.9
504100      1    2  900 16.6 16.4  8.1
504100      1    3  600 19.9 19.6 10.2
504100      1    4  400 23.3 22.3 11.2
504100      2    1 1100 12.1 11.7  3.9
504100      2    2  800 15.6 17.4  7.1
504100      2    3  650 18.9 18.6  9.2
504100      3    4 8000  1.0  2.0  0.0
504108      1    1  600 32.9 28.1 15.0
504108      2    4 9000  1.9  1.5  0.3")
